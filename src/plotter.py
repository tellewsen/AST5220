...
plt.figure(9)
plt.plot(x_t,deltam[0],label = r'$\delta_{1}$')
plt.plot(x_t,deltam[1],label = r'$\delta_{5}$')
plt.plot(x_t,deltam[2],label = r'$\delta_{10}$')
plt.plot(x_t,deltam[3],label = r'$\delta_{40}$')
plt.plot(x_t,deltam[4],label = r'$\delta_{60}$')
plt.plot(x_t,deltam[5],label = r'$\delta_{100}$')
